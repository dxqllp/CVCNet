...
parser.add_argument('--exp', type=str,  default='CVCNet', help='exp_name')
parser.add_argument('--model', type=str,  default='cvcnet3d', help='model_name')
...
def test_calculate_metric():
    ...
    net = net_factory(net_type='cvcnet3d', in_chns=1, class_num=num_classes, mode="test")
