...
parser.add_argument('--exp', type=str, default='CVCNet', help='experiment_name')
parser.add_argument('--model', type=str, default='cvcnet2d', help='model_name')
...
def test_single_volume(case, net, test_save_path, FLAGS):
    ...
    for ind in range(image.shape[0]):
        ...
        net.eval()
        with torch.no_grad():
            out_main = net(input,input,input)
            if len(out_main)>1:
                out_main=out_main[0]
